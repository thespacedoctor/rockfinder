...
exclude_patterns = ['_build', '_templates',
                    '**__version__.py', '**setup.py', 'api/rockfinder.rst']
...
modindex_common_prefix = ["rockFinder."]
...
# of the sidebar.
html_logo = "_images/rockfinder-icon.png"
...
latex_documents = [
    ('index', 'rockfinder.tex', u'rockfinder Documentation',
     u'Dave Young', 'manual'),
]
...
man_pages = [
    ('index', 'rockfinder', u'rockfinder Documentation',
     [u'Dave Young'], 1)
]
...
texinfo_documents = [
    ('index', 'rockfinder', u'rockfinder Documentation',
     u'Dave Young', 'rockfinder', 'A python package and command-line suite to generate solar-system body ephemerides and to determine if specific transient dections are in fact known asteroids',
     'Miscellaneous'),
]
...
def updateUsageRST():
    ...
    from rockfinder import cl_utils
...
def generateAutosummaryIndex():
    ...
    # GET ALL SUBPACKAGES
    allSubpackages = ["rockfinder"]
    allSubpackages += findAllSubpackges(
        pathToPackage="rockfinder"
    )
